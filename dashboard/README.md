...
| I3.4.1 Beneficiários de PSA | MMA / Portal da Transparência | Sem série por UF hoje. O **CNPSA**, cadastro nacional que a Lei 14.119/2021 criou justamente para consolidar os beneficiários de PSA, **ainda está em construção**, com conclusão prevista para o ano seguinte. O painel do Bolsa Verde no gov.br/mma está sob restrição de defeso eleitoral até 25/10/2026. O programa não aparece nos downloads em massa do Portal da Transparência. **Mas o caminho existe:** o endpoint `api.portaldatransparencia.gov.br/api-de-dados/bolsa-verde-por-municipio` responde **401 e não 404** — ou seja, existe e entrega dados por município; basta uma chave de API, que o portal concede a quem se cadastra. Com ela, dá para montar a série do Bolsa Verde por UF. O que ela não cobre são os programas estaduais (Bolsa Floresta, REM), que a ficha atribui aos estados e que ninguém consolida. |
